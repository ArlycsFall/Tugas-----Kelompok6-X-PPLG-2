...
$result = $conn->query($query);
if ($result) {
    $total_dokumen = $result->fetch_assoc()['total'];
}
...
<head>
    ...
    <title>Beranda Guru - Mandis</title>
    <link rel="stylesheet" href="beranda_guru.css">
    ...
    <div class="main">
        ...
        <div class="topbar">
              ...
              <div class="welcome-section">
                ...
                <p>Sebagai Guru, Anda dapat melihat dan mengelola data siswa di sistem.</p>
              </div>
